...
const AddDonation = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setSubmitError(error.response?.data?.error || 'Failed to record donation');
        ...
        {showSuccess && (
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-green-800">Donation recorded successfully!</p>
                <p className="text-xs text-green-600 mt-1">Redirecting to donations list...</p>
              </div>
            </div>
          </motion.div>
        )}
        ...
        {submitError && (
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-red-800">Error recording donation</p>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-[rgb(31,178,86)] to-[rgb(25,142,69)] px-6 py-5">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white">Record New Donation</h2>

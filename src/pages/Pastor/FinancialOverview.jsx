// pages/Pastor/FinancialOverview.jsx
...
const PastorFinancialOverview = () => {
  ...
  const fetchFinancialData = async () => {
    try {
      ...
      console.log('📊 Fetching financial data for pastor with params:', params);
      ...
      if (financialData.income.length === 0 && financialData.expenses.length === 0) {
        toast.success('No transaction data found for this period', { icon: 'ℹ️' });
      }
        ...
        {comparisonData.length > 0 ? (
          ...
          <div className="h-80 flex items-center justify-center text-gray-500">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 mt-2">Try adjusting your date range</p>
            </div>
          </div>
        )}
      </motion.div>
    ...
    >
      ...
      {balanceSheet ? (
        ...
        <div className="bg-white rounded-xl shadow-sm p-12 text-center border border-gray-200">
          ...
          <p className="text-gray-500">Balance sheet information is not available for the selected date.</p>
        </div>
      )}
    </motion.div>
  );
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Welcome back, {user?.firstName || 'Pastor'}. Here's your church's financial performance.
            </p>
          </div>
...
export default PastorFinancialOverview;